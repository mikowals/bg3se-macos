...
368 tests in `tests/harness/`. Run with pytest, no game dependency.
...
114 tests requiring a loaded save (entity access, Osiris queries, physics, pathfinding, StaticData layouts, and parity contracts).
